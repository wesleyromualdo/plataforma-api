...
Revision ID: 992b64ffbbab
Revises: 
Create Date: 2024-03-27 15:19:26.503207
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('tarefa_id', sa.Integer(), nullable=True),
    sa.Column('tx_chave', sa.String(length=300), nullable=True),
    sa.Column('tx_valor', sa.String(length=1000), nullable=True),
    sa.Column('bo_status', sa.Boolean(), server_default='t', nullable=True),
    sa.Column('dt_inclusao', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['tarefa_id'], ['tarefa.id'], name='fk_tarefa_configuracao'),
    sa.PrimaryKeyConstraint('id')
    )
